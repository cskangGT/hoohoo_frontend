export const Utils = {
    ...
    isSameMonthAndYear: function (date: any, month: number, year: number) {
        if (date) {
    ...
    shallowDiff: function (a: any, b: any, exclusions = []) {
        const diffs = [];
    ...
    compareDates: function (a: any, b: any, granularity: any) {
